...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fab.setOnClickListener { view ->
            ...
            //finds the activity view by id
            recyclerViewList = findViewById(R.id.list_recyclerView)
            //creates the layout for the recycler view
            recyclerViewList.layoutManager = LinearLayoutManager(this)
            //this sets the recyclerView adapter
            recyclerViewList.adapter = ListSelectionRecyclerViewAdapter()
